        ...
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-6 max-w-sm text-sm opacity-70">
              Motorradkurse Zürich. Ausbildung, Weiterbildung und Vermietung —
              kompromisslos in Qualität, präzise in der Ausführung.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li><Link to="/kurse" className="opacity-80 hover:opacity-100">Grundkurse</Link></li>
              <li><Link to="/kurse" className="opacity-80 hover:opacity-100">WAB / 2-Phasen</Link></li>
              <li><Link to="/vermietung" className="opacity-80 hover:opacity-100">Vermietung</Link></li>
              <li><Link to="/standorte" className="opacity-80 hover:opacity-100">Standorte</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm opacity-80">
              <li>Seestrasse 1<br />8810 Horgen</li>
