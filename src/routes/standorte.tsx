    ...
    <>
      ...
      <main className="pt-16">
        ...
        <section className="relative h-[85vh] min-h-[560px] overflow-hidden bg-surface text-surface-foreground">
          <img src={horgenImg} alt="Horgen am Zürichsee" className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="relative z-10 mx-auto flex h-full max-w-[1600px] flex-col justify-end px-6 pb-20 md:px-10 md:pb-28">
            ...
            <h1 className="display-xl mt-6 max-w-5xl">Heute Horgen.<br /><span className="opacity-70">Morgen die Schweiz.</span></h1>
            ...
            <div className="grid gap-16 md:grid-cols-12">
              ...
              <div className="md:col-span-9">
                ...
                <p className="mt-6 max-w-2xl text-base opacity-80 md:text-lg">
                  Direkt am Zürichsee, 25 Minuten ab Zürich HB. Unser Übungsgelände,
                  unsere Mietflotte, unser Klassenzimmer.
                </p>

                <div className="mt-16 grid gap-12 md:grid-cols-3">
                  <Detail label="Adresse" value={<>Seestrasse 1<br />8810 Horgen<br />Schweiz</>} />
                  <Detail label="Öffnungszeiten" value={<>Mo–Fr · 08:00–18:00<br />Sa · 08:00–14:00<br />So · geschlossen</>} />
                  <Detail label="Anreise" value={<>S2/S8 bis Horgen<br />A3 Ausfahrt 38<br />Parkplätze vorhanden</>} />
                </div>
            ...
            <div className="mb-16 grid gap-6 md:grid-cols-12">
              ...
              <div className="md:col-span-9">
                ...
                <p className="mt-6 max-w-xl text-base opacity-75">
                  Wir prüfen aktiv Partnerschaften mit etablierten Fahrschulen.
                  Nächste Standorte in Planung:
                </p>
              </div>
            </div>
