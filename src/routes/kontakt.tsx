...
const topics = ["Grundkurs", "WAB", "A1 / A35 / A", "Theoriekurs", "Vermietung", "Partnerschaft", "Anderes"];
      ...
      <main className="pt-16">
        ...
        <section className="bg-background">
          <div className="mx-auto grid max-w-[1600px] gap-px bg-border md:grid-cols-3">
            <ContactTile icon={<Phone className="size-4" />} label="Telefon" value="+41 44 000 00 00" href="tel:+41440000000" />
            <ContactTile icon={<Mail className="size-4" />} label="E-Mail" value="info@motorradkurse-zuerich.ch" href="mailto:info@motorradkurse-zuerich.ch" />
            <ContactTile icon={<MapPin className="size-4" />} label="Standort" value="Seestrasse 1, 8810 Horgen" href="https://maps.google.com/?q=Seestrasse+1+Horgen" />
          </div>
        </section>
          ...
          <div className="mx-auto max-w-[1600px] px-6 py-24 md:px-10 md:py-32">
            <div className="grid gap-16 md:grid-cols-12">
              <div className="md:col-span-4">
                ...
                <h2 className="display-lg mt-4">Schreiben<br />Sie uns.</h2>
                <p className="mt-8 max-w-sm text-base opacity-70">
                  Je präziser Ihre Anfrage, desto schneller können wir den
                  passenden Kurs oder Termin vorschlagen.
                </p>
                ...
                {sent ? (
                  <div className="flex h-full flex-col items-start justify-center border-t border-border-strong pt-12">
                    ...
                    <p className="mt-6 max-w-md text-base opacity-70">
                      Ihre Nachricht ist bei uns angekommen. Wir antworten
                      innerhalb eines Werktages.
                    </p>
                  </div>
                ) : (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-6 border-t border-border-strong pt-8">
                      <p className="max-w-md text-xs opacity-60">
                        ...
                        Wir verwenden Ihre Daten ausschliesslich zur Bearbeitung
                        Ihrer Anfrage.
                      </p>
                      <button type="submit" className="btn-pill-solid bg-foreground text-background">
...
function ContactTile({ icon, label, value, href }: { icon: React.ReactNode; label: string; value: string; href: string }) {
  return (
    ...
    >
      <div>
        <div className="eyebrow flex items-center gap-2 opacity-60">{icon} {label}</div>
