  ...
  notFoundComponent: () => (
    <>
      ...
      <main className="pt-32 pb-32 text-center">
        ...
        <Link to="/kurse" className="btn-pill mt-10 inline-flex">Zur Übersicht <ArrowRight className="size-4" /></Link>
      </main>
      <Footer />
    </>
  ),
      ...
      <main>
        ...
        <section className="relative h-[90vh] min-h-[600px] overflow-hidden bg-surface text-surface-foreground">
          ...
          <div className="relative z-10 mx-auto flex h-full max-w-[1600px] flex-col justify-end px-6 pb-20 md:px-10 md:pb-28">
            <Link to="/kurse" className="mb-8 inline-flex items-center gap-2 text-sm opacity-80 hover:opacity-100">
            ...
            <div className="grid gap-16 md:grid-cols-12">
              ...
              <div className="space-y-6 md:col-span-7">
                {course.longDescription.map((p, i) => (
                  <p key={i} className="text-base opacity-80 md:text-lg">{p}</p>
                ))}
              </div>
            </div>
            ...
            <div className="mt-24 md:mt-32">
              ...
              <ul className="mt-8 border-t border-border-strong">
                {course.modules.map((m, i) => (
                  <li key={m.title} className="grid gap-6 border-b border-border py-10 md:grid-cols-12 md:gap-12">
            ...
            <div>
              ...
              <ul className="mt-8 space-y-4">
                {course.includes.map((i) => (
                  <li key={i} className="flex items-start gap-3 border-t border-white/20 pt-4 text-base">
          ...
          <div className="mx-auto max-w-[1600px] px-6 py-24 md:px-10 md:py-32">
            <div className="grid gap-12 md:grid-cols-12">
              ...
              <div className="md:col-span-9">
                <h2 className="display-xl">Bereit für<br />{course.shortTitle}?</h2>
